...
// const data = [
//     { id: 5, code: "KADI10", productCode: "123123", qty: 3, amount: "4320 دج", profit: "63 دج", date: "12/07/2025" },
//     { id: 1, code: "KADI10", productCode: "123123", qty: 3, amount: "4320 دج", profit: "63 دج", date: "12/07/2025" },
//     { id: 1, code: "KADI10", productCode: "123123", qty: 3, amount: "4320 دج", profit: "63 دج", date: "12/07/2025" },
//     { id: 1, code: "KADI10", productCode: "123123", qty: 3, amount: "4320 دج", profit: "63 دج", date: "12/07/2025" },
//     { id: 1, code: "KADI10", productCode: "123123", qty: 3, amount: "4320 دج", profit: "63 دج", date: "12/07/2025" },
//     { id: 1, code: "KADI10", productCode: "123123", qty: 3, amount: "4320 دج", profit: "63 دج", date: "12/07/2025" },
...
//     { id: 1, code: "KADI10", productCode: "123123", qty: 3, amount: "4320 دج", profit: "63 دج", date: "12/07/2025" },
//     { id: 1, code: "KADI10", productCode: "123123", qty: 3, amount: "4320 دج", profit: "63 دج", date: "12/07/2025" },
//     { id: 2, code: "KADI10", productCode: "123123", qty: 2, amount: "2900 دج", profit: "45 دج", date: "15/07/2025" },
//   { id: 3, code: "KADI20", productCode: "789789", qty: 1, amount: "1200 دج", profit: "20 دج", date: "20/07/2025" },
// ];
// export default function StatisticsPage() {
//   return (
//     <SidePanel menuItems={menuItems}>
//       <div className="flex flex-col w-full h-full space-y-4 pb-4 pr-4 pl-4 overflow-x-hidden">
        
//         {/* Titre */}
//         <div className="px-2">
//           <h2 className="font-semibold text-xl text-[#182544]">
//             إحصائيات عامة حول آخر كود برومو:
//           </h2>
//         </div>

//         {/* Statistiques */}
//         <div className="grid grid-cols-3 gap-6 text-center bg-white">
//           <div className=" rounded-2xl bg-[#FCFBFB] shadow-[0_4px_4px_rgba(0,0,0,0.25)] py-3 px-6 ">
//             <div className="text-2xl font-bold text-yellow-500">1980 دج</div>
//             <div className="text-[rgb(55,65,81)] font-medium">إجمالي التخفيضات</div>
//           </div>
//           <div className=" rounded-2xl bg-[#FCFBFB] shadow-[0_4px_4px_rgba(0,0,0,0.25)] py-3 px-6">
//             <div className="text-2xl font-bold text-gray-800">30</div>
//             <div className="text-[#374151] font-medium">إجمالي عدد الطلبات</div>
//           </div>
//           <div className=" rounded-2xl  bg-[#FCFBFB] shadow-[0_4px_4px_rgba(0,0,0,0.25)] py-3 px-6">
//             <div className="text-2xl font-bold text-green-600">630 دج</div>
//             <div className="text-[#374151]  font-medium">إجمالي الربح</div>
//           </div>
//         </div>
...
//         {/* Tableau */}
//         <div className="bg-[#FCFBFB] rounded-2xl w-full shadow-[0_4px_4px_rgba(0,0,0,0.25)] border max-h-[500px] overflow-y-auto">
//           {/* Header */}
//           <div className="sticky top-0 grid grid-cols-7 gap-4 p-4 bg-[#FCFBFB] border-b-[1.5px] border-[#E5B62B] 
...
//                 <div>{row.qty}</div>
//                 <div>{row.amount}</div>
//                 <div className="text-green-600 font-semibold">{row.profit}</div>
//               </div>
//             ))}
//           </div>
//         </div>

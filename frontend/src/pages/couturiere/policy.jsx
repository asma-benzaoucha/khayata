...
// return (
// <div className="flex flex-col items-center text-right p-8 max-w-3xl mx-auto">
//     {/* Logo */}
...
//         سياسة الاستخدام
//     </h1>
//     <ShieldCheck className="text-[#F0C84B]" size={28} />
//     </div>

//     {/* Contenu */}
//     <div className="space-y-6 leading-8 text-[#374151]">
//     <section className="bg-[#F9F9F6] p-6 rounded-2xl shadow-md border border-[#E5E5D9]">
//         <h2 className="text-xl font-semibold mb-2 text-[#F0C84B]">مقدمة</h2>
//         <p>
//         مرحبًا بك في منصتنا. باستخدامك لهذا الموقع، فإنك توافق على جميع
//         الشروط والسياسات المذكورة أدناه. نرجو قراءة هذه الشروط بعناية.
//         </p>
//     </section>

//     <section className="bg-[#F9F9F6] p-6 rounded-2xl shadow-md border border-[#E5E5D9]">
//         <h2 className="text-xl font-semibold mb-2 text-[#F0C84B]">
//         حقوق المستخدم
//         </h2>
//         <ul className="list-disc pr-6 space-y-2">
//         <li>لديك الحق في تصفح المنصة والاستفادة من خدماتها.</li>
//         <li>يحق لك إنشاء حساب شخصي آمن وسري.</li>
...
//         </h2>
//         <ul className="list-disc pr-6 space-y-2">
//         <li>عدم استخدام الموقع في أي نشاط غير قانوني.</li>
//         <li>الالتزام بسياسة الخصوصية وحماية البيانات.</li>
//         <li>الامتناع عن نشر محتوى مسيء أو مخالف للأعراف.</li>
//         </ul>
//     </section>
...
//         </h2>
//         <p>
//         يحق للإدارة تعديل شروط الاستخدام وسياسة الخصوصية في أي وقت، وسيتم
//         إخطار المستخدمين بالتحديثات.
//         </p>
//     </section>
//     </div>

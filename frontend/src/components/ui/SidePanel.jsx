  ...
  //   const handleLogout = () => {
  //     // Ici tu peux vider le token du localStorage
  ...
  //       {/* Sidebar */}
  //       <aside className="flex flex-col items-center w-64 m-4 rounded-3xl bg-white border-[#DDDDC6] border-[5px]">
  //         {/* Logo */}
  ...
  //       {/* Main zone */}
  //       <main className="flex-1 m-4 rounded-xl border-[#DDDDC6] border-[5px] shadow-inner bg-white p-6 overflow-auto">
  //         {children}
  //       </main>
  ...
  //             <p className="text-lg font-semibold mb-4">هل أنت متأكد أنك تريد تسجيل الخروج؟</p>
